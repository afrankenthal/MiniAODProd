...
## This script to be used when only one lifetime per mass point is
## needed or desired. Replace the name of the runOffGridpack script
## in submit.py to use. For 2018 studies.
...
cmsDriver.py step2 \
    ...
    --nThreads 8 --era Run2_2018 --python_filename ${namebase}_AOD_cfg.py --no_exec \
